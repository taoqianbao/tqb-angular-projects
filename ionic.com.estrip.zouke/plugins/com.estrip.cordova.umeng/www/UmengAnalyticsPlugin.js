cordova.define("com.estrip.cordova.umeng.UmengAnalyticsPlugin", function(require, exports, module) { var UmengAnalyticsPlugin = function () {
};
...
UmengAnalyticsPlugin.prototype.onKillProcess = function (data) {
    this.call_native("onKillProcess", [data], null);
}

UmengAnalyticsPlugin.prototype.onResume = function (data) {
    this.call_native("onResume", [data], null);
}
UmengAnalyticsPlugin.prototype.onPause = function (data) {
